...
public class Consts {
    ...
    // 広告ID
    public static final String AD_ID_BANNER = "ca-app-pub-8748062155851740/7416886915";
    public static final String AD_ID_RESULT = "ca-app-pub-8748062155851740/4323819716";
